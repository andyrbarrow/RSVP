...
<body>
    <div class = "wrapper">    
        <span class = "firstcharacter">R</span>aw <span class = "firstcharacter">S</span>core <span class = "firstcharacter">V</span>iewing <span class = "firstcharacter">P</span>rogram
    </div>    
    <div class="wrapper">
        <h2>Login</h2>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Just want to view raw score images? You don't need to sign in. <a href="downloads.php">Click Here</a></p>
        </form>
    </div>
</body>
</html>
